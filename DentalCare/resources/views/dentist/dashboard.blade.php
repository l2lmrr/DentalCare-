...
@section('content')
<div class="py-6 px-4 sm:px-6 lg:px-8">    <div class="sm:flex sm:items-center mb-8">
        ...
        <div class="mt-4 sm:mt-0 sm:ml-16">
            <a href="{{ route('appointments.calendar') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                View Calendar
            </a>
        </div>
    </div>
    ...
    <div class="mb-12">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            </div>            <div class="px-4 py-3 bg-gray-50 sm:px-6">
                <!-- Pagination removed as we're using a collection, not paginated results -->
            </div>
        </div>
